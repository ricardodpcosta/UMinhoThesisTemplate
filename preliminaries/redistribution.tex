...
\noindent \textbff{Licen\c ca concedida aos utilizadores deste trabalho:} 

\vspace{0.5cm}

% CC BY
\noindent \includegraphics[width=2.5cm]{preamble/creative_commons/by.png}\\
\noindent \textbff{Atribui\c c\~ao CC}\\
\noindent \textbff{BY}\\
