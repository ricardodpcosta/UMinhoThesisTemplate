...
% officially published in "Despacho RT-31/2019"
...
% 1.2 - Templates for the covers in SVG format for doctoral theses and master works are provided,
...
% and comment the predefined selection as necessary
...
%------------------------------------------------------------------------------------
% leave this uncommented for the Chapter 1
\chapterformat
\input{chap1/chap1.tex}
%------------------------------------------------------------------------------------
% leave this uncommented for the Chapter 2
\chapterformat
