...
\newcommand{\chaptersformat}{
	...
	\pagestyle{bodystyle}
	\ifthenelse{\equal{\doclanguage}{portuguese}}{
		\titleformat{\chapter}[block]{\SetTracking[no ligatures={f}]{encoding=*}{40}}{\filright\parbox[b][2.2cm][t]{3.5cm}{\MakeUppercase{\Large{Cap\'itulo}}\raisebox{-0.8\height}{\resizebox{!}{2.2cm}{\Huge\thechapter}}}}{3ex}{\parbox[b][2.2cm]{\dimexpr\linewidth-3.5cm-1.6pt-3ex\relax}{\titlerule[1.5pt]\vspace{1.5ex}\vfill\endgraf\filright\bf\Large{\thechaptertitlefont ##1}\vfill}}
	}{
		\titleformat{\chapter}[block]{\SetTracking[no ligatures={f}]{encoding=*}{40}}{\filright\parbox[b][2.2cm][t]{3.5cm}{\MakeUppercase{\Large{Chapter}}\raisebox{-0.8\height}{\resizebox{!}{2.2cm}{\Huge\thechapter}}}}{3ex}{\parbox[b][2.2cm]{\dimexpr\linewidth-3.5cm-1.6pt-3ex\relax}{\titlerule[1.5pt]\vspace{1.5ex}\vfill\endgraf\filright\bf\Large{\thechaptertitlefont ##1}\vfill}}
	}
